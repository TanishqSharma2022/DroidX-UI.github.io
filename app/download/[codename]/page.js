      ...
      <Fade>
        <div className=" w-full p-12 place-items-center grid md:grid-cols-2 grid-cols-1">
          ...
          <div className=" flex flex-col">
            <div className="py-6 ">
              <h1 className="font-sans font-semibold text-2xl md:text-5xl">
                {searchParams.model}
              </h1>
              <h3 className="italic text-md md:text-lg">
              ...
              <div className="w-full grid grid-cols-2 py-6 gap-6 ">
                ...
                <div className="p-2 ">
                  ...
                  <h3 className="font-semibold text-md md:text-xl">
                    {searchParams.maintainer_name}
                  </h3>
                </div>

                {searchParams.co_maintainer_name && (
                  <div className="p-2 ">
