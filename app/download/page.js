            ...
            <div>
                <div className="w-full flex flex-col items-center justify-center text-center font-sans  text-5xl p-4 mt-4">
                    ...
                    <h1 className="text-3xl font-bold p-4">Select your device</h1>
                        ...
                        <input type="text" className="mt-5 text-xl min-w-[300px] bg-secondary brightness-75 text-color p-4 rounded-full w-[50%] " placeholder="Find your device..." />
        ...
        <pre className='device_content grid grid-cols-1 gap-5 mt-5 md:grid-cols-2'>
                ...
                {Device.map((dev) => {
                    ...
                    return(
                        ...
                        <div className="shadow-lg rounded-2xl max-w-[400px] w-[97%] h-[300px] bg-secondary p-4 " key={id}>
